...
export default function BrandsWeUse() {
  ...
  return (
    <section className="bg-charcoal border-y border-gold/15 py-8 overflow-hidden">
        ...
        <div className="flex items-center justify-around flex-wrap gap-6 md:gap-12 opacity-80">
          {brands.map((brand, idx) => (
            <motion.div
              ...
              className="text-cream/70 font-serif text-[11px] sm:text-xs md:text-sm tracking-[0.25em] font-medium hover:text-gold hover:scale-105 transition-all duration-300"
            >
              {brand}
            </motion.div>
          ))}
